...
camera_filename = '_'.join([filename_prefix, 'traj'])
filename_suffix = '.txt'
...
shutil.copy(os.path.join('../../config', 'BotanicGarden_camera.yaml'), os.path.join(sequence_name, filename_prefix, current_testfolder_name, 'config', 'BotanicGarden_camera.yaml'))
shutil.copy(os.path.join('../../config', 'BotanicGarden_lidar.yaml'), os.path.join(sequence_name, filename_prefix, current_testfolder_name, 'config', 'BotanicGarden_camera.yaml'))
